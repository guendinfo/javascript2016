...
class Route {
    ...
    constructor(lib, options) {
        ...
        Hoek.assert(options.schema.todoRequest, 'schema must contain heroRequest value to have good schema'); // no schema
        Hoek.assert(options.schema.updateTodoRequest, 'schema must contain updateHeroRequest value to have good schema'); // no schema
        Hoek.assert(options.schema.todoResponse, 'schema must contain heroResponse value to have good schema'); // no schema
